...
function setToArray(mySet) {
  ...
  const result = mySet.filter((elem) => typeof elem !== "number");
...
function iterateSet(set) {
  ...
  const newSet = set.entries(myKey, myValue);
